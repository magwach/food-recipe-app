                    ...
                    <div className="flex flex-col items-center">
                        ...
                        : recipeData?.recipes ? 
                            recipeData.recipes.map((item, key) => {
                                return(
                                    <div key={key} className="flex flex-col p-4 bg-[#f8f8f8] h-80 lg:h-150 rounded-lg hover:h-85 duration-100 hover:w-70 cursor-pointer lg:hover:h-180 lg:hover:w-150 hover:z-1">
